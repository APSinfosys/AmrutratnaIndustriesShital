...
{
    public partial class Dashboard_YarnOutward : Form
    {
        public Dashboard_YarnOutward()
        {
            InitializeComponent();
        }
        ...
        //YON.UniqueCode as [UNIQUE CODE],YON.YO_Code as [CODE], YON.YO_GetpassNo as [GETPASS], YON.YO_Date as [DATE],LM.L_ShadeName+' - '+LM.L_ShadeLocation as [SHADE], 4
        ...
        private void Dashboard_YarnOutward_Load(object sender, EventArgs e)
        {
            FillGrid(101);
        }
        ...
        {
            Yarn.YarnOutword frm = new Yarn.YarnOutword();
            frm.newOrEdit = 0;
            frm.ShowDialog();
            FillGrid(101);
        }
        ...
        //            YON.tara,
        //YON.part,YON.measure,YON.MillName,YON.LotNo --,QR.Q_Name
