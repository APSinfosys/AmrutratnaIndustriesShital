...
{
    public partial class Dashboard_SizingInward_Tippan : Form
    {
        public Dashboard_SizingInward_Tippan()
        {
            InitializeComponent();
        }
        ...
        #endregion
        private void Dashboard_SizingInward_Tippan_Load(object sender, EventArgs e)
        {
            FillGrid(101);
        }
        ...
        {
            Sizing.Sizing_Tippan frm = new Sizing.Sizing_Tippan();
            frm.newOrEdit = 0;
            frm.ShowDialog();
            FillGrid(101);
        }
        ...
        private void btnEdit_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                if (dgvDesign.SelectedRows.Count > 0)
                {
                    ...
                    frm.txtTotalBeams.Text = dgvDesign.CurrentRow.Cells[46].Value.ToString();
