...
{
    public partial class Dashboard_Viving : Form
    {
        public Dashboard_Viving()
        {
            InitializeComponent();
        }
        ...
        private void Dashboard_Viving_Load(object sender, EventArgs e)
        {
            FillGrid(101);
        }
        ...
        private void btnEdit_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    Viving.VivingLoad frm = new Viving.VivingLoad();
                    frm.newOrEdit = 1;
           ...
           //                    VM.VI_Code as [CODE], VM.VI_Date as [DATE],MLM.L_ShadeName+' - '+MLM.L_ShadeLocation as [SHADE],CV.Common_Value as [LOOM TYPE], 
                    ...
                    frm.cmbLNV= Convert.ToInt32(dgvSut.CurrentRow.Cells[4].Value.ToString());
           ...
           //VM.SatNo as [SAT NO], VM.SatCount as [COUNT], VM.BeamNo as [BI NO], VM.BiCut as [BI CUT], 
                    ...
                    frm.cmbBV = Convert.ToInt32(dgvSut.CurrentRow.Cells[15].Value.ToString());
                    frm.cmbQV = Convert.ToInt32(dgvSut.CurrentRow.Cells[16].Value.ToString());
           //VM.ShadeName, VM.LoomType,VM.PartyName,VM.BiNo
                    frm.ShowDialog();
                   // frm.FillGrid(101);
                    FillGrid(101);
