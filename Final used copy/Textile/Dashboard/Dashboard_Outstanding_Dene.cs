...
{
    public partial class Dashboard_Outstanding_Dene : Form
    {
        public Dashboard_Outstanding_Dene()
        {
            InitializeComponent();
        }
        ...
        private void Dashboard_Outstanding_Dene_Load(object sender, EventArgs e)
        {
            FillGrid(102);
        }
    }
