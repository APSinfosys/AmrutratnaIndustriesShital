...
{
    public partial class WeavingLoadAuto : Form
    {
        public WeavingLoadAuto()
        {
            InitializeComponent();
        }
            ...
            try
            {
                ...
                if (QueryNo == 1 || QueryNo == 2)
                {
                   ...
                   // hash.Add("@decBiCut", Convert.ToDecimal(lblBiCuts.Text));
                    ...
                    hash.Add("@decBiMeterIn", Convert.ToDecimal(lblBiCuts.Text));
        ...
        private void WeavingLoadAuto_Load(object sender, EventArgs e)
        {
            FillGrid(201);
            //FillGrid(204);
            FillGrid(401);
        ...
        {
            if (cmbBiNO.Text != "<--SELECT-->" && cmbBiNO.Text != "<--NO RECORD-->" && Convert.ToInt32(cmbBiNO.SelectedIndex) > -1 && cmbBiNO.SelectedValue != null
